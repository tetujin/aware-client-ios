...
@synthesize sharedAWARECoreManager = _sharedAWARECoreManager;
- (AWARECoreManager *) sharedAWARECoreManager {
    if(_sharedAWARECoreManager == nil){
        _sharedAWARECoreManager = [[AWARECoreManager alloc] init];
    }
    return _sharedAWARECoreManager;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _sharedAWARECoreManager = [[AWARECoreManager alloc] init];
    [_sharedAWARECoreManager activate];
...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    if (notification){
        ...
        Debug * debugSensor = [[Debug alloc] initWithAwareStudy:_sharedAWARECoreManager.sharedAwareStudy];
...
- (void)application:(UIApplication *)application performFetchWithCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^{
        ...
        Debug * debug = [[Debug alloc] initWithAwareStudy:_sharedAWARECoreManager.sharedAwareStudy];
...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
    ...
    PushNotification * pushNotification = [[PushNotification alloc] initWithSensorName:nil withAwareStudy:_sharedAWARECoreManager.sharedAwareStudy];
...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification{
    ...
    AWAREStudy * awareStudy = _sharedAWARECoreManager.sharedAwareStudy;
...
- (void) changedBatteryState:(id) sender {
    ...
    if (batteryState == UIDeviceBatteryStateCharging || batteryState == UIDeviceBatteryStateFull) {
        ...
        [_sharedAWARECoreManager.sharedSensorManager syncAllSensorsWithDBInBackground];
        [_sharedAWARECoreManager.sharedSensorManager runBatteryStateChangeEvents];
    }
}
...
didSignInForUser:(GIDGoogleUser *)user
    ...
    if (name != nil ) {
        ...
        GoogleLogin * googleLogin = [[GoogleLogin alloc] initWithSensorName:SENSOR_PLUGIN_GOOGLE_LOGIN withAwareStudy:_sharedAWARECoreManager.sharedAwareStudy];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "edu.dartmouth.cs.StudentLife" in the application's documents directory.
