...
- (void)syncAwareDB{
    [awareHKWorkout syncAwareDB];
    [awareHKCategory syncAwareDB];
    [awareHKQuantity syncAwareDB];
    [super syncAwareDB];
}

- (void)syncAwareDBInBackground{
    [awareHKWorkout syncAwareDBInBackground];
    [awareHKCategory syncAwareDBInBackground];
    [awareHKQuantity syncAwareDBInBackground];
    [super syncAwareDBInBackground];
}

- (BOOL)syncAwareDBInForeground{
    [awareHKWorkout syncAwareDBInForeground];
    [awareHKCategory syncAwareDBInForeground];
    [awareHKQuantity syncAwareDBInForeground];
